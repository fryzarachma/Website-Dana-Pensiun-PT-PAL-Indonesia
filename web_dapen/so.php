   ...
   <div id="banner-area" class="banner-area" style="background-image:url(images/banner/8.jpg)">
            ...
            <div class="row">
               <div class="col-xs-12">
                  <div class="banner-heading">
                     ...
                     <ol class="breadcrumb">
                        <li>DANA PENSIUN KARYAWAN</li>
                        <a href="#">PT PAL INDONESIA</a>
                     </ol>
                  </div>
               </div><!-- Col end -->
            </div><!-- Row end -->
         ...
         <div class="row">
            <!-- <div class="col-md-10"> -->
               <div id="page-slider" class="owl-carousel owl-theme page-slider page-slider-small">
                  <div class="item">
                     <img src="images/so.jpg" alt="" height="500" width="500"/>
                  <!-- </div> -->
